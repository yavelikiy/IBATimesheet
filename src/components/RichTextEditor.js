...
export default class RichTextEditor extends Component {
    ...
    try {
      ...
      switch (message.type) {
        ...
        case messages.ZSS_INITIALIZED:
          ...
          this.setEditable(this.props.isTitleEditable, this.props.isContentEditable);
  ...
  render() {
    ...
    //const pageSource = PlatformIOS ? require('../assets/editor.html') : { uri: 'file:///android_asset/editor2.html' };
    const pageSource = { uri: 'file:///android_asset/editor2.html' };
    return (
      <View style={{flex: 1}}>
        <WebViewBridge
          {...this.props}
  ...
  setEditable(isTitleEditable, isContentEditable) {
    this._sendAction(actions.setEditable, {isTitleEditable, isContentEditable});
  }
