...
function getDefaultIcon() {
  const texts = {};
  texts[actions.insertImage] = require('../assets/img/icon_format_media.png');
  texts[actions.setBold] = require('../assets/img/icon_format_bold.png');
  texts[actions.setItalic] = require('../assets/img/icon_format_italic.png');
  texts[actions.insertBulletsList] = require('../assets/img/icon_format_ul.png');
  texts[actions.insertOrderedList] = require('../assets/img/icon_format_ol.png');
  texts[actions.insertLink] = require('../assets/img/icon_format_link.png');
  return texts;
}
